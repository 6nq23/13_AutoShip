...
5. Xpressbees Surface
6. Xpressbees Surface_Stressed
7. Delhivery Surface DT
```

The first successful booking wins. If all seven services reject the shipment, AutoShip marks that order as failed and records every attempt in the job log.
